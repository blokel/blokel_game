...
minetest.register_node("default:waterfall_flowing", {
	description = "Flowing Water",
	inventory_image = minetest.inventorycube("default_water.png"),
	drawtype = "flowingliquid",
	tiles = {"default_water.png"},
	...
	drowning = 2,
	liquidtype = "flowing",
	liquid_alternative_flowing = "default:waterfall_flowing",
	liquid_alternative_source = "default:waterfall_source",
	liquid_viscosity = WATER_VISC,
	--post_effect_color = {a = 120, r = 50, g = 90, b = 30},
	groups = {water = 3, liquid = 3, puts_out_fire = 1, not_in_creative_inventory = 1},
})

minetest.register_node("default:waterfall_source", {
	description = "Water Source",
	inventory_image = minetest.inventorycube("default_water.png"),
	drawtype = "liquid",
	tiles = {
