...
minetest.register_on_newplayer(function(player)
	print("[blokel] giving initial stuff to player")
	player:get_inventory():add_item('main', 'default:pick_wood')
	player:get_inventory():add_item('main', 'default:torch 5')
	player:get_inventory():add_item('main', 'default:cobble 5')
	player:get_inventory():add_item('main', 'default:wood 5')
	player:get_inventory():add_item('main', 'default:apple 5')
end)

if minetest.setting_getbool("log_mods") then
	minetest.log("action", "[blokel]: All mods loaded.")
end
...
if minetest.setting_getbool("log_mods") then
	...
	minetest.log("action", "[blokel]: * [default] loaded.")
end
