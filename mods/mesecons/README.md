...
Mesecons is a mod for [Minetest](http://minetest.net/) (now for Blokel!) that implements a ton of items related to digital circuitry, such as wires, buttons, lights, and even programmable controllers. Among other things, there are also pistons, solar panels, pressure plates, and note blocks.
...
Notice
--------------------------
Thanks so much Jeija and contributors for doing this! Mesecons is a huge part of Blokel and is very helpful!
