Simple V7 for Minetest Game on Mapgen v7 by MTDad and devmarth v. 1.0
License: WTFPL
Depends: Default (Minetest Game) or (Blokel Game)
Minetest Version: Should work from 0.4.8 to 0.4.10

This has been modified dramatically, much of the original code is not in recognizable form. And the generation will be much better with our edits.
